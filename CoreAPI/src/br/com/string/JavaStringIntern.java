...
public class JavaStringIntern {
	public static void main(String[] args) {
		...
		System.out.println("Are str1 and str4 the same: " + (str1 == str4)); // this should be "false" because str4 is
																				// not interned

		System.out.println("Are str1 and str4.intern() the same: " + (str1 == str4.intern())); // this should be "true"
																								// now

		System.out.println("Are str1 and str5 the same: " + (str1 == str5));
		System.out.println(String.format("Meu nome é %s", "renato"));
